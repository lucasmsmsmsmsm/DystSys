...
public final class TurnstileServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest,
      distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse> getCheckPinMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckPin",
      requestType = distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest.class,
      responseType = distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest,
      distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse> getCheckPinMethod() {
    io.grpc.MethodDescriptor<distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest, distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse> getCheckPinMethod;
      ...
      synchronized (TurnstileServiceGrpc.class) {
        if ((getCheckPinMethod = TurnstileServiceGrpc.getCheckPinMethod) == null) {
          TurnstileServiceGrpc.getCheckPinMethod = getCheckPinMethod =
              io.grpc.MethodDescriptor.<distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest, distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckPin"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse.getDefaultInstance()))
  ...
  public static abstract class TurnstileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void checkPin(distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest request,
        io.grpc.stub.StreamObserver<distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest,
                distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse>(
  ...
  public static final class TurnstileServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TurnstileServiceBlockingStub> {
    ...
    /**
     */
    public distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse checkPin(distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest request) {
  ...
  public static final class TurnstileServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TurnstileServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse> checkPin(
        distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_PIN:
          serviceImpl.checkPin((distsys.recruitmentday.turnstile.Turnstile.CheckPinRequest) request,
              (io.grpc.stub.StreamObserver<distsys.recruitmentday.turnstile.Turnstile.CheckPinResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TurnstileServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return distsys.recruitmentday.turnstile.Turnstile.getDescriptor();
    }
