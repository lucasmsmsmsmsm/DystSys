...
public final class WaitServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<distsys.recruitmentday.time.Time.WaitTimeRequest,
      distsys.recruitmentday.time.Time.WaitTimeUpdate> getStreamWaitTimeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamWaitTime",
      requestType = distsys.recruitmentday.time.Time.WaitTimeRequest.class,
      responseType = distsys.recruitmentday.time.Time.WaitTimeUpdate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<distsys.recruitmentday.time.Time.WaitTimeRequest,
      distsys.recruitmentday.time.Time.WaitTimeUpdate> getStreamWaitTimeMethod() {
    io.grpc.MethodDescriptor<distsys.recruitmentday.time.Time.WaitTimeRequest, distsys.recruitmentday.time.Time.WaitTimeUpdate> getStreamWaitTimeMethod;
      ...
      synchronized (WaitServiceGrpc.class) {
        if ((getStreamWaitTimeMethod = WaitServiceGrpc.getStreamWaitTimeMethod) == null) {
          WaitServiceGrpc.getStreamWaitTimeMethod = getStreamWaitTimeMethod =
              io.grpc.MethodDescriptor.<distsys.recruitmentday.time.Time.WaitTimeRequest, distsys.recruitmentday.time.Time.WaitTimeUpdate>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamWaitTime"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.recruitmentday.time.Time.WaitTimeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  distsys.recruitmentday.time.Time.WaitTimeUpdate.getDefaultInstance()))
  ...
  public static abstract class WaitServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void streamWaitTime(distsys.recruitmentday.time.Time.WaitTimeRequest request,
        io.grpc.stub.StreamObserver<distsys.recruitmentday.time.Time.WaitTimeUpdate> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                distsys.recruitmentday.time.Time.WaitTimeRequest,
                distsys.recruitmentday.time.Time.WaitTimeUpdate>(
  ...
  public static final class WaitServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<WaitServiceBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<distsys.recruitmentday.time.Time.WaitTimeUpdate> streamWaitTime(
        distsys.recruitmentday.time.Time.WaitTimeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_STREAM_WAIT_TIME:
          serviceImpl.streamWaitTime((distsys.recruitmentday.time.Time.WaitTimeRequest) request,
              (io.grpc.stub.StreamObserver<distsys.recruitmentday.time.Time.WaitTimeUpdate>) responseObserver);
          break;
        default:
  ...
  private static abstract class WaitServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return distsys.recruitmentday.time.Time.getDescriptor();
    }
